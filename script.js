...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbxcwnuRkLyzIyXiFSr2UJOyvrvS3UeSF0NjePw_RI2d1wLCMJgUVVVlN82yJ9O9WqKD/exec?getNumeroEntrada")
    ...
    async function enviarDatos(data, btn) {
        try {
            await fetch("https://script.google.com/macros/s/AKfycbxcwnuRkLyzIyXiFSr2UJOyvrvS3UeSF0NjePw_RI2d1wLCMJgUVVVlN82yJ9O9WqKD/exec", {
                method: "POST",
                mode: "no-cors",
            ...
            const response = await fetch("https://script.google.com/macros/s/AKfycbxcwnuRkLyzIyXiFSr2UJOyvrvS3UeSF0NjePw_RI2d1wLCMJgUVVVlN82yJ9O9WqKD/exec?getNumeroEntrada");
