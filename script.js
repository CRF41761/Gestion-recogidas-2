...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function enviarDatos(data, btn) {
        try {
            await fetch("https://script.google.com/macros/s/AKfycbwP6-vugVYdtc40MRA1pG-y6Vw752URDsA5dN9Pq7QeuuZLH52NDdkczBZ02QHUb6RH/exec", {
                method: "POST",
                mode: "no-cors",
            ...
            const response = await fetch("https://script.google.com/macros/s/AKfycbwP6-vugVYdtc40MRA1pG-y6Vw752URDsA5dN9Pq7QeuuZLH52NDdkczBZ02QHUb6RH/exec?getNumeroEntrada");
