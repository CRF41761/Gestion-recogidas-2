...
document.addEventListener("DOMContentLoaded", function () {
    ...
    mapElement.parentNode.insertBefore(locateButton, mapElement.nextSibling);
        ...
        fetch("https://script.google.com/macros/s/AKfycbyqLrhriIazHJkslY4QO7rDlfnT5yibLJI9ZRyjzL21L5B_Ou9xgrLADNmrZDzp-7qM/exec?funcion=getNumeroEntrada", {
        method: "GET",
        mode: "cors"
    })
    .then(response => {
    ...
    async function enviarDatos(data, btn) {
        try {
            await fetch("https://script.google.com/macros/s/AKfycbyqLrhriIazHJkslY4QO7rDlfnT5yibLJI9ZRyjzL21L5B_Ou9xgrLADNmrZDzp-7qM/exec", {
                method: "POST",
                mode: "no-cors",
            ...
            try {
                ...
                console.error('Error guardando en IndexedDB:', dbError);
                        ...
                        const response = await fetch("https://script.google.com/macros/s/AKfycbyqLrhriIazHJkslY4QO7rDlfnT5yibLJI9ZRyjzL21L5B_Ou9xgrLADNmrZDzp-7qM/exec?funcion=getNumeroEntrada", {
                method: "GET",
                mode: "cors"
            });
            if (!response.ok) throw new Error(`HTTP error! status: ${response.status}`);
