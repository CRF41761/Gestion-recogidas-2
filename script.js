...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbxgqxpsYhqUTvRH9hCcdeq5ew1jePz9ZehXpXWM-_4df06TFxZuMz6amHipc_CyJ9_k/exec?getNumeroEntrada")
    ...
    async function enviarDatos(data, btn) {
        try {
            await fetch("https://script.google.com/macros/s/AKfycbxgqxpsYhqUTvRH9hCcdeq5ew1jePz9ZehXpXWM-_4df06TFxZuMz6amHipc_CyJ9_k/exec", {
                method: "POST",
                mode: "no-cors",
            ...
            const response = await fetch("https://script.google.com/macros/s/AKfycbxgqxpsYhqUTvRH9hCcdeq5ew1jePz9ZehXpXWM-_4df06TFxZuMz6amHipc_CyJ9_k/exec?getNumeroEntrada");
