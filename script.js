...
document.addEventListener("DOMContentLoaded", function () {
    ...
    try {
        ...
        await fetch("https://script.google.com/macros/s/AKfycbwLhZR0D-dY2nKrwd9DwuR9L-NoLJB6WstUYo6DIFKS736zVrOsvh2u7UxAm1PqhREv/exec", {
            method: "POST",
            mode: "no-cors",
        ...
        const response = await fetch("https://script.google.com/macros/s/AKfycbwLhZR0D-dY2nKrwd9DwuR9L-NoLJB6WstUYo6DIFKS736zVrOsvh2u7UxAm1PqhREv/exec?funcion=getAllData", {
            method: "GET",
            mode: "cors"
        });
