document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbxXXF2CwhNKFslC8AlyOcrzC2qFMc3eTwTSWrPm5ziPvYguJ7Mx1XXuzv3kBkulDYIP/exec?getNumeroEntrada") // Reemplaza con tu URL de Apps Script
   ...
   document.getElementById("formulario").addEventListener("submit", function (event) {
    ...
    function enviarDatos(data) {
        fetch("https://script.google.com/macros/s/AKfycbxXXF2CwhNKFslC8AlyOcrzC2qFMc3eTwTSWrPm5ziPvYguJ7Mx1XXuzv3kBkulDYIP/exec", {
            method: "POST",
            mode: "no-cors",  
            headers: {
