...
document.addEventListener("DOMContentLoaded", function () {
    ...
    try {
        ...
        await fetch("https://script.google.com/macros/s/AKfycbxT7mTNvGmkVz3f62SqmADRGl5ehwXAnHfEUOkfiemEZSUENQsvn2jwSnbYAFtRi_4r/exec", {
            method: "POST",
            mode: "no-cors",
        ...
        const response = await fetch("https://script.google.com/macros/s/AKfycbxT7mTNvGmkVz3f62SqmADRGl5ehwXAnHfEUOkfiemEZSUENQsvn2jwSnbYAFtRi_4r/exec?funcion=getAllData", {
            method: "GET",
            mode: "cors"
        });
