document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbz_5ROzqT8gNhY3i7MDtIFWcftYhnC5miJHPfxtyGYBxoJAdJ1GPSFGKDj5MoUcpKcH/exec?getNumeroEntrada") // Reemplaza con tu URL de Apps Script
   ...
   document.getElementById("formulario").addEventListener("submit", function (event) {
    ...
    function enviarDatos(data) {
        fetch("https://script.google.com/macros/s/AKfycbz_5ROzqT8gNhY3i7MDtIFWcftYhnC5miJHPfxtyGYBxoJAdJ1GPSFGKDj5MoUcpKcH/exec", {
            method: "POST",
            mode: "no-cors",  
            headers: {
