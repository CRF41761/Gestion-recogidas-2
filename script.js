document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbzAmVCtQw7CSo9xoafVTJ8caq-h-EPYPKsOnHlWk0o2nE9pK8_bsmbYEzyQwfyuxXV8/exec?getNumeroEntrada") // Reemplaza con tu URL de Apps Script
   ...
   document.getElementById("formulario").addEventListener("submit", function (event) {
    ...
    function enviarDatos(data) {
        fetch("https://script.google.com/macros/s/AKfycbzAmVCtQw7CSo9xoafVTJ8caq-h-EPYPKsOnHlWk0o2nE9pK8_bsmbYEzyQwfyuxXV8/exec", {
            method: "POST",
            mode: "no-cors",  
            headers: {
