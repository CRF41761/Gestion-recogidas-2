...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbwSuH8hughZjdw7vfzBTeFu9u67hPaMh8Pg0it1-Qyp9dMZkzXWUojIKnyeSD-9c6UI/exec?getNumeroEntrada")
    ...
    async function enviarDatos(data, btn) {
        try {
            await fetch("https://script.google.com/macros/s/AKfycbwSuH8hughZjdw7vfzBTeFu9u67hPaMh8Pg0it1-Qyp9dMZkzXWUojIKnyeSD-9c6UI/exec", {
                method: "POST",
                mode: "no-cors",
            ...
            const response = await fetch("https://script.google.com/macros/s/AKfycbwSuH8hughZjdw7vfzBTeFu9u67hPaMh8Pg0it1-Qyp9dMZkzXWUojIKnyeSD-9c6UI/exec?getNumeroEntrada");
